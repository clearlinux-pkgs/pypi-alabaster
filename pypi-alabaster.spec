...
Source0  : https://files.pythonhosted.org/packages/c9/3e/13dd8e5ed9094e734ac430b5d0eb4f2bb001708a8b7856cbf8e084e001ba/alabaster-0.7.16.tar.gz
...
%prep
%setup -q -n alabaster-0.7.16
cd %{_builddir}/alabaster-0.7.16
pushd ..
cp -a alabaster-0.7.16 buildavx2
popd
pushd ..
cp -a alabaster-0.7.16 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707109780
...
cp %{_builddir}/alabaster-%{version}/LICENSE.rst %{buildroot}/usr/share/package-licenses/pypi-alabaster/ef0bbb4479d44765f2402160812f3f860befe8f8 || :
